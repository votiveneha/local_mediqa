                ...
                <div class="card shadow-sm border-0 p-4 mt-30">
                  ...
                  <form id="educert_form" method="POST" novalidate onsubmit="return educert()">
                    ...
                    <div class="another_certifications">
                      ...
                      $i = 1;
                      $l = 0;
                      print_r($additional_certificate);
                      ?>
                    ...
                    <div class="previous_employeers">
                      ...
                      <div class="work_exp exp_tab-1">
                        ...
                        <div class="form-group level-drp">
                          ...
                          <input class="form-control upload_evidence-1" type="file" multiple="" onchange="changeExpEvidenceImg({{ Auth::guard('nurse_middle')->user()->id }},1,0)" id="1">
