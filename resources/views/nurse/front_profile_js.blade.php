            ...
            <div class="work_exp work_exp_${previous_employeers_head}">
               ...
               <div class="specialty_sub_boxes_experience-${previous_employeers_head} row">
                ...
                <div class="form-group level-drp">
                    ...
                    <input class="form-control upload_evidence-${previous_employeers_head}" type="file" name="upload_evidence[${previous_employeers_head}][]" onchange="changeExpEvidenceImg({{ Auth::guard('nurse_middle')->user()->id }},${previous_employeers_head},0)" id="${previous_employeers_head}" multiple>
