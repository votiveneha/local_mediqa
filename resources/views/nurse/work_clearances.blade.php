                      ...
                      <div id="specialized_more" >
                        ...
                        <div class="add_specialized" >
                          ...
                          <div class="form-group ">
                            ...
                            <?php
                              $work_evidence_specialized   = DB::table("work_evidance")->where('evidance_type', 5)->where('type_id', $svalue->id)->get(); 
                            ?>
        ...
        $('#add-wwcc').click(function(){
          ...
          $('#wwcc_more').append(`<div class="add_wwcc" >
                          ...
                          <div class="form-group ">
                            ...
                            <div id="fileList" class="file-list file-list-wc"></div>
                          </div>
