                                    ...
                                    <div class="row">
                                        <div class="reference_form">
                                            ...
                                            <div class="referee_data referee_data-{{ $i }}">
                                                ...
                                                @if($referee_data->still_working != 1)
                                                <div class="col-md-12 mt-3">
...
<script>
    ...
    <?php
        ...
        if(!empty($employee_postion_data)){
            foreach($employee_postion_data as $emp_data){
                $referee_position .= "<li data-value=".$emp_data->position_id.">".$emp_data->position_name."</li>";
            }
        }
    ?>
    console.log("referee_position","<?php echo $referee_position; ?>"); 
    function add_another_referee() {
        referee_div_count++;
        var referee_position = "<?php echo $referee_position; ?>";
        const i = referee_div_count;
        var ap = "ap";
$('.reference_form').append(`
  <div class="referee_data referee_data-${i}">
    ...
    <div>
      <div class="col-md-12 mt-3">
        <div class="form-group level-drp">
          <label class="d-flex gap-3 flex-wrap" for="input-1"><strong>First name</strong></label>
          <input class="form-control first_name first_name-${i}" type="text" name="first_name[]">
          <span id="reqfname-${i}" class="reqError text-danger valley"></span>
        </div>
      </div>
      ...
      <div class="col-md-12 mt-3">
        <div class="form-group level-drp">
          <label class="d-flex gap-3 flex-wrap" for="input-1"><strong>Last name</strong></label>
          <input class="form-control last_name last_name-${i}" type="text" name="last_name[]">
          <span id="reqlname-${i}" class="reqError text-danger valley"></span>
        </div>
      </div>
    </div>
    ...
    <div>
      <div class="col-md-12">
        <div class="form-group level-drp">
          <label class="d-flex gap-3 flex-wrap" for="input-1"><strong>Email</strong></label>
          <input class="form-control reference_email reference_email-${i}" type="text" name="email[]">
          <span id="reqemail-${i}" class="reqError text-danger valley"></span>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="form-group level-drp">
          <label class="d-flex gap-3 flex-wrap" for="input-1"><strong>Phone number</strong></label>
          <input class="form-control phone_no phone_no-${i}" type="text" name="phone_no[]">
    ...
    <div>
      <div class="col-md-12 mt-3">
        <div class="form-group level-drp">
          <label class="d-flex gap-3 flex-wrap" for="input-1"><strong>Relationship</strong></label>
          <select class="form-control reference_relationship reference_relationship-${i}" name="reference_relationship[]">
      ...
      <div class="col-md-12 mt-3">
        <div class="form-group level-drp">
          <label class="d-flex gap-3 flex-wrap" for="input-1"><strong>You worked together at:</strong></label>
          <input class="form-control worked_together worked_together-${i}" type="text" name="worked_together[]">
          <span id="reqworked_together-${i}" class="reqError text-danger valley"></span>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group level-drp">
          <label class="form-label" for="input-1">What was your position when you worked with this referee?</label>
          <ul id="position_held_listr-${i}" style="display:none;">${referee_position}</ul>
          <select
            class="js-example-basic-multiple${i} addAll_removeAll_btn pos_heldr pos_heldr_${i}"
            data-list-id="position_held_listr-${i}"
            name="positions_heldr[${i}]"
            id="position_held_fieldr-${i}"
            multiple
            onchange="getPostionsr(${ap}, ${i})">
          </select>
          <span id="reqposworked-${i}" class="reqError text-danger valley"></span>
        </div>
      </div>
      <div class="show_positionsr-${i})"></div>
    </div>

    <div>
      <div class="col-md-12 mt-3">
        <div class="form-group level-drp">
          <label class="d-flex gap-3 flex-wrap" for="input-1"><strong>Start Date</strong></label>
          <input class="form-control start_date start_date-${i}" type="date" name="start_date[]" onchange="startDate(${i})" onkeydown="return false">
      ...
      <div class="col-md-12 mt-3">
        <div class="form-group level-drp working-${i}">
          <label class="d-flex gap-3 flex-wrap" for="input-1"><strong>End Date</strong></label>
          <input class="form-control end_date end_date-${i}" type="date" name="end_date[]" onkeydown="return false">
          <span id="reqrefereeedate-${i}" class="reqError text-danger valley"></span>
        </div>
      </div>
      ...
      <div>
        <div class="declaration_box">
          <input class="still_working still_working-${i}" type="checkbox" name="still_working[]" onclick="stillWorking(${i})">
          I am still working with this referee
          <span id="reqstillworking-${i}" class="reqError text-danger valley"></span>
        </div>

        <div class="col-md-12 mt-3">
          <div class="add_new_certification_div mb-3">
            <a style="cursor: pointer;" onclick="delete_reference1(${i})">- Delete Referee</a>
          </div>
        </div>
      </div>
    </div>
