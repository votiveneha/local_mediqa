                    ...
                    success: function(res) {
                        ...
                        if (res.status == '2') {
                            Swal.fire({
                                ...
                                let pathParts = fullPath.split("/").filter(part => part !== "");
                                let uriSegment = pathParts[0];
                                let path = "{{ route('admin.setting_availablity') }}";
                                let newUrl = window.location.protocol + "//" + window.location.host + "/mediqa/admin/setting_availablity?tab=" + targetTab;
                                console.log("newUrl",fullPath);
