                    ...
                    <div class=" w-100  overflow-hidden">
                        ...
                        <div class="card-body p-3 px-md-4">
                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <div class="ahpra_details">
                                            ...
                                            <div class="ahpra_lookup_details">
                                                ...
                                                <label>
                                                    <input type="checkbox" id="isAdmin" @if($licensesData->ahpra_reverify == "1") checked @endif>&nbsp; I am admin (override cooldown)
                                                </label>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-12 mt-3">
                                    @if ($licensesData->immunization_state != NULL)
                                    <div class="ndis_registered_provider mt-1">
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col-md-12">
                                                ...
                                                <div>
                                                    ...
                                                    @foreach($radiation_licence_type as $radiation_licence)
                                                    @if($radiation_licence != "other")
                                                    <span class="badge bg-dark me-1">{{ $licenses_array[$radiation_licence] }}</span>
                                                    @else
                                                    <span class="badge bg-dark me-1">{{ $licensesData->licenses_type_other }}</span>
                                                    @endif
                                                    @endforeach
                                                    @endif
                                                </div>
                                            ...
                                            <?php
                                                ...
                                                //print_r($radiation_licenses_no);
                                            ?>
                                            @if($licence_type != "other")
                                            <div class="radiation_licenses">
                                                <h5>{{ $licence_name }}</h5>
                                                @if(!empty($radiation_licenses_no))
                                                @foreach($radiation_licenses_no as $index=>$radiation_licence)
                                                @if ($index != "other")
                                                <div class="mb-3 col-md-12">
                                                    <label class="form-label fw-semibold">State of Issue</label>
                                                    
                                                    <div>
                                                        @foreach($radiation_licence->state_issue as $radiation_licence_state)
                                                        
                                                        <span class="badge bg-dark me-1">{{ $state_options[$radiation_licence_state] }}</span>
                                                        @endforeach
                                                ...
                                                <div class="mb-3 col-md-12">
                                                    <label class="form-label fw-semibold">Licensing Body</label>
                                                    <?php
                                                        $licenceBodies = [
                                                            'environment_protection' => 'EPA NSW – Environment Protection Authority',
                                                            'radiation_safety' => 'Department of Health – Radiation Safety',
                                                            'radiation_health' => 'Queensland Health – Radiation Health',
                                                            'radiation_protection' => 'SA EPA – Radiation Protection',
                                                            'radiological_council' => 'Radiological Council of WA',
                                                            'health_department' => 'Radiation Protection Unit – Department of Health',
                                                            'health_nt' => 'Department of Health NT Radiation Safety',
                                                            'health_protection' => 'Health Protection Service',
                                                        ];
                                                        //print_r($radiation_licenses_no);
                                                    ?>
                                                    <div>
                                                        @foreach($radiation_licence->licence_body as $radiation_licence_body)
                                                        
                                                        <span class="badge bg-dark me-1">{{ $licenceBodies[$radiation_licence_body] }}</span>
                                                        @endforeach
                                                ...
                                                <?php
                                                    $radiation_state_data = (array)json_decode($licensesData->radiation_state_data);
                                                ?>
                                                
                                                @foreach($radiation_state_data[$index] as $index1=>$radiation_licence)
                                                <h6>{{ $state_options[$index1] }}</h6>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <strong>Licence Number:</strong>
                                                        <span>
                                                            {{ $radiation_licence->radiation_licenses_no }}
                                                        </span>  
                                                    </div>    
                                                    <div class="col-md-6">
                                                        <strong>Issue Date:</strong>
                                                        <span>
                                                            {{ $radiation_licence->radiation_issue_date }}
                                                        </span>  
                                                    </div>    
                                                    <div class="col-md-6">
                                                        <strong>Expiry Date:</strong>
                                                        <span>
                                                            {{ $radiation_licence->radiation_expiry_date }}
                                                        </span>  
                                                    </div>    
                                                    <div class="col-md-6">
                                                        <strong>Evidence:</strong>
                                                        <div class="evidence_img_list">
                                                            ...
                                                            <ul>
                                                                <?php
                                                                    if($radiation_licence->evidence){
                                                                        $evidence_imgs = (array)json_decode($radiation_licence->evidence);
    ...
    $('#isAdmin').click(function(){
        if ($('#isAdmin').prop('checked')) {
            $.ajax({
                ...
                data: {
                    ahpra_reverify: '1',
                    user_id: '@if(!empty($licensesData)){{ $licensesData->user_id }}@endif',
                    _token:"{{ csrf_token() }}"
                },
