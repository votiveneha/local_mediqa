            ...
            <div class="tab-pane p-3" id="tab-9" role="tabpanel">
                <div class="row">
                    <div class="card shadow-sm border-0 p-4 mt-30">
                        ...
                        @csrf
                        <!-- Other form fields -->
                        <input type="hidden" name="user_id" class="user_id" value="{{ $user_data->id }}">    
                        <div class="form-check mt-3">
                          <input class="form-check-input" type="checkbox" value="1" id="visibleToMedicalFacilities" {{ $user_data->medical_facilities=='Yes' ? 'checked' : '' }}
                        ...
                        <div class="form-check mt-3">
                          <input class="form-check-input" type="checkbox" value="1" id="visibleToAgencies" {{ $user_data->agencies =='Yes'? 'checked' : '' }} name="agencies">
                          <label class="form-check-label" for="visibleToAgencies">
                            Visible to Agencies
                          </label>
                        </div>
                        <div class="form-check mt-3">
                          <input class="form-check-input" type="checkbox" value="1" id="visibleToIndividuals" {{ $user_data->individuals =='Yes'? 'checked' : '' }} name="individuals">
                          <label class="form-check-label" for="visibleToAgencies">
                        ...
                        <div class="form-check  mt-1  mb-2">
                          <input class="form-check-input" type="radio" value="1" id="availableNow" name="profile_status" @if($user_data->profile_status1 == '1') checked @endif>
                        ...
                        <div class="form-check  mt-1  mb-2">
                          <input class="form-check-input" type="radio" value="0" id="unavailableNow" name="profile_status" @if($user_data->profile_status1 == '0') checked @endif>
                        ...
                        <div class="form-group available_date_field d-none">
                          ...
                          <input type="date" id="available_date" name="available_date" class="form-control" value="{{ $user_data->available_date }}" onkeydown="return false">
                        </div>
                        <div class="form-group level-drp d-none available_start_dropdown">
                            ...
                            <select class="form-control" name="start_job_dropdown" id="start_job_dropdown">
                                ...
                                <option value="Immediately" @if(!empty($user_data) && $user_data->start_job_dropdown == "Immediately") selected @endif>Immediately</option>
                                <option value="Within 2 weeks" @if(!empty($user_data) && $user_data->start_job_dropdown == "Within 2 weeks") selected @endif>Within 2 weeks</option>
                                <option value="Within 1 month" @if(!empty($user_data) && $user_data->start_job_dropdown == "Within 1 month") selected @endif>Within 1 month</option>
                                <option value="More than 1 month" @if(!empty($user_data) && $user_data->start_job_dropdown == "More than 1 month") selected @endif>More than 1 month</option>
                            </select>    
                        </div>        
                        <div class="form-group drp--clr">
                            <label class="form-label" for="input-1">Do you need help with any of the following? </label>
                            
                            <input type="hidden" name="any_help_input" class="any_help_input" value='{{ $user_data->any_help }}'>
      ...
      success: function(resp) {
        ...
        if (resp.status == 1) {
          ...
          Swal.fire({
            ...
            window.location.href = "{{ route('admin.setting_availablity',['id'=>$user_data->id]) }}";
            });
