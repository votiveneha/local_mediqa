...
class NurseController extends Controller
{
    ...
    public function viewExpTab(Request $request, $id = null)
    {
        $profileData  = $this->nurseRepository->getOneUser(['id' => $request->id]);
        $experienceData  = "";
        if ($id) {
        ...
        return view('admin.experience-tab', compact('experienceData','profileData'));
    }
    ...
    public function Experienceupdate(Request $request)
    {
        ...
        // $user_id = User::where('email', $request->)->first();
        // if ($user_id) {
        //     $userId = $user_id->id;
        // } else {
        //     $userId = $userid;
    ...
    public function update_profession_profile_setting(Request $request)
    {
        ...
        $run = DB::table("users")->where('id', $request->user_id)->update($update);
